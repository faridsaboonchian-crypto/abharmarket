...
def make_shop_standee(shop_id, shop_name, bot_username):
    # لینک به صورت هوشمند از روی نام رباتی که شما در خط آخر می‌دهید ساخته می‌شود
    link = f"https://ble.ir/{bot_username}?start=shop_{shop_id}"
    ...
    title_text = "خرید آنلاین و سفارش سریع"
...
# ==========================================
# تنظیمات خروجی (فقط این قسمت را تغییر دهید)
# پارامتر اول: آیدی فروشگاه در ربات
# پارامتر دوم: نام فروشگاه
